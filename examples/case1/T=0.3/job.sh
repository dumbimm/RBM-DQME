...
file1=$yourfolder/NADO_torch_github/examples/case1/T=\0.03/steady_state
file2=$yourfolder/NADO_torch_github/examples/case1/T=\0.03/td



# #1-a: Solving steady state with simulating rho
# cd $file1
